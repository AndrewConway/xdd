...
fn compute_rot_pidd_c(factory:&mut PermutationDecisionDiagramFactory::<LeftRotation>,n:PermutedItem,k:PermutedItem) -> NodeIndex {
...
fn compute_rot_pidd_a(factory:&mut PermutationDecisionDiagramFactory::<LeftRotation>,n:PermutedItem,k:PermutedItem) -> NodeIndex {
...
fn test_compute_rot_pidd_c() {
    fn test(n:PermutedItem,k:PermutedItem) {
        let mut factory = PermutationDecisionDiagramFactory::<LeftRotation>::new(n as u16);
