...
fn zdd_basic_ops<F:XDDBase<usize, NoMultiplicity>+Default>() {
    ...
    let all_solutions_v1 = factory.find_all_solutions_with_minimal_true_arguments::<u64, false>(v1, 2);
    assert_eq!(1,all_solutions_v1.number_solutions());
    assert_eq!(Some(vec![VariableIndex(1)]),all_solutions_v1.get_ith_solution(0));
    assert_eq!(None,all_solutions_v1.get_ith_solution(1));
    assert_eq!(None,all_solutions_v1.get_ith_solution(42));
    let all_solutions_v0 = factory.find_all_solutions_with_minimal_true_arguments::<u64, false>(v0, 2);
    assert_eq!(1,all_solutions_v0.number_solutions());
    assert_eq!(Some(vec![VariableIndex(0)]),all_solutions_v0.get_ith_solution(0));
    assert_eq!(None,all_solutions_v0.get_ith_solution(1));
    assert_eq!(None,all_solutions_v0.get_ith_solution(42));
    let all_solutions_not_v0 = factory.find_all_solutions_with_minimal_true_arguments::<u64, false>(not_v0, 2);
    assert_eq!(1,all_solutions_not_v0.number_solutions());
    assert_eq!(Some(vec![]),all_solutions_not_v0.get_ith_solution(0));
    assert_eq!(None,all_solutions_not_v0.get_ith_solution(1));
    assert_eq!(None,all_solutions_not_v0.get_ith_solution(42));
    let all_solutions_or_v0_v1 = factory.find_all_solutions_with_minimal_true_arguments::<u64, false>(or_v0_v1, 2);
    assert_eq!(2,all_solutions_or_v0_v1.number_solutions());
    assert_eq!(Some(vec![VariableIndex(1)]),all_solutions_or_v0_v1.get_ith_solution(0));
    assert_eq!(Some(vec![VariableIndex(0)]),all_solutions_or_v0_v1.get_ith_solution(1));
    assert_eq!(None,all_solutions_or_v0_v1.get_ith_solution(2));
    assert_eq!(None,all_solutions_or_v0_v1.get_ith_solution(42));
    let all_solutions_and_v0_v1 = factory.find_all_solutions_with_minimal_true_arguments::<u64, false>(and_v0_v1, 2);
    assert_eq!(1,all_solutions_and_v0_v1.number_solutions());
    assert_eq!(Some(vec![VariableIndex(0),VariableIndex(1)]),all_solutions_and_v0_v1.get_ith_solution(0));
    assert_eq!(None,all_solutions_and_v0_v1.get_ith_solution(1));
    assert_eq!(None,all_solutions_and_v0_v1.get_ith_solution(42));
